...
if __name__ == "__main__":
    ...
    if ARGS.env == 'peg':
        register_env(temp_env_name, lambda _: PEGDrones(num_pursuer_drones=ARGS.num_pursuer_drones,
                                                        num_evader_drones=ARGS.num_evader_drones,
    ...
    if ARGS.env == 'peg':
        temp_env = PEGDrones(num_pursuer_drones=ARGS.num_pursuer_drones,
                             num_evader_drones=ARGS.num_evader_drones,
                             aggregate_phy_steps=shared_constants.AGGR_PHY_STEPS,
                             obs=ARGS.obs,
                             act=ARGS.act
